...
VC_REGISTRY: list[VCFund] = [
    ...
    VCFund("Elevation Capital (SAIF)", 2001, "Paytm, BookMyShow, Swiggy", "Consumer, SaaS, Logistics", "Growth Stage", "$1.8B", "Ravi Adusumalli, Mukul Arora"),  # careers page is VC internal only
    ...
    VCFund("Stellaris Venture Partners", 2016, "Mamaearth, mFine", "Tech, Consumer", "Early Stage", "$160M", "Ritesh Banglani, Alok Goyal"),  # no working portfolio job board
