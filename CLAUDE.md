...
This is a Python async CLI tool for aggregating PM job listings across 13 platforms, VC portals, MNC career pages, funding trackers, and automated email outreach. The user is a Senior PM candidate targeting Delhi NCR, 5-7 yrs exp, 50+ LPA, Tech/SaaS/B2B.
